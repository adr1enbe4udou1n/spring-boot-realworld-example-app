...
public class ArticleListTest extends RealworldApplicationTests {
  ...
  private User createArticles() {
    ...
    List<String> johnFavoritedArticles =
        Arrays.asList(
            new String[] {
              "jane-article-1",
              "jane-article-2",
  ...
  public void can_paginate_article() {
    ...
    given()
        ...
        .when()
        .get(baseUrl + "/api/articles?limit=10&offset=20")
        .then()
        .statusCode(200)
        ...
        .body("articles[0].body", equalTo("Test Body"))
        .body("articles[0].author.username", equalTo("John Doe"))
        ...
        .body("articles[0].author.following", equalTo(false))
        .body("articles[0].favorited", equalTo(false))
        .body("articles[0].favoritesCount", equalTo(0))
        .body(
            "articles[0].tagList",
            equalTo(Arrays.asList(new String[] {"John Tag", "Tag 1", "Tag 2"})))
  ...
  public void can_filter_articles_by_author() {
    ...
    given()
        .contentType(ContentType.JSON)
        .when()
        .get(baseUrl + "/api/articles?limit=10&offset=0&author=John Doe")
        .then()
        .statusCode(200)
        .body("articles.size()", equalTo(10))
        .body("articles[0].title", equalTo("John Article 30"))
  ...
  public void can_filter_articles_by_tag() {
    ...
    given()
        .contentType(ContentType.JSON)
        .when()
        .get(baseUrl + "/api/articles?limit=10&offset=0&tag=Jane Tag")
        .then()
        .statusCode(200)
        .body("articles.size()", equalTo(10))
        ...
        .body("articles[0].description", equalTo("Test Description"))
        .body("articles[0].body", equalTo("Test Body"))
        .body("articles[0].author.username", equalTo("Jane Doe"))
        .body("articles[0].author.bio", equalTo("Jane Bio"))
        .body(
            "articles[0].author.image", equalTo("https://randomuser.me/api/portraits/women/1.jpg"))
        .body("articles[0].author.following", equalTo(false))
        .body("articles[0].favorited", equalTo(false))
        .body("articles[0].favoritesCount", equalTo(0))
        .body(
            "articles[0].tagList",
            equalTo(Arrays.asList(new String[] {"Jane Tag", "Tag 1", "Tag 2"})))
  ...
  public void can_filter_articles_by_favorited() {
    ...
    actingAs(user)
        .contentType(ContentType.JSON)
        .when()
        .get(baseUrl + "/api/articles?limit=10&offset=0&favorited=John Doe")
        .then()
        .statusCode(200)
        .body("articles.size()", equalTo(5))
        .body("articles[0].title", equalTo("Jane Article 16"))
  ...
  public void can_paginate_feed() {
    ...
    actingAs(user)
        .contentType(ContentType.JSON)
        .when()
        .get(baseUrl + "/api/articles/feed?limit=10&offset=0")
        .then()
        .statusCode(200)
        .body("articles.size()", equalTo(10))
        .body("articles[0].title", equalTo("Jane Article 20"))
