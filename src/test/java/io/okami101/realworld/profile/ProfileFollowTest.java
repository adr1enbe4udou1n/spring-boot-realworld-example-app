...
public class ProfileFollowTest extends RealworldApplicationTests {
    ...
    public void cannot_follow_non_existent_profile() {
        actingAsJohnUser().when().post(baseUrl + "/api/profiles/celeb_Jane Doe/follow").then().statusCode(404);
    }
    ...
    public void can_follow_profile() {
        ...
        actingAsJohnUser().when().post(baseUrl + "/api/profiles/celeb_Jane Doe/follow").then().statusCode(200)
    ...
    public void can_unfollow_profile() {
        ...
        actingAs(john).when().delete(baseUrl + "/api/profiles/celeb_Jane Doe/follow").then().statusCode(200)
